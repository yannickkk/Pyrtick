...
# Date:     06/11/2024
# Version: 1.0.0
# Description: récupération des données du formulaire App_Identif_tiques sur ODK central et archivage des données sur le S3 au format csv2 et xlsx
# Documentation:
#------------------------------------------------------------------------------
...
formulaire<-"App_Identif_tiques_V.1.3"
#####il faut relire les constantes de façon à ce que le formulaire soit sélectionné
...
#recupere_soumission(nom_du_projet=projet,nom_du_formulaire=formulaire,"API","","CSV",csv,FALSE)
...
if (dim(dat)[1] !=0) {
  ...
  fichiers_a_supprimer <- list.files(csv, pattern = "Identif", full.names = TRUE)
